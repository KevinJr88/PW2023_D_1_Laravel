                                    ...
                                    <div class="modal fade" id="editMenu{{ $item['id'] }}" tabindex="-1" aria-labelledby="confirmationModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <form action="{{ route('menu.edit', $item['id'] ) }}" method="POST " enctype="multipart/form-data">
                                                    @method('PUT')
                                                    @csrf
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="p-2">
                                                            <div class="input-group">
                                                                <input type="file" class="form-control" id="inputGroupFile02" value="DeliciousPizza.png" readonly>
                                                                <label class="input-group-text" for="inputGroupFile02">Food
                                                                    Picture</label>
                                                            </div>
                                                        </div>
                                                        <div class="p-2">
