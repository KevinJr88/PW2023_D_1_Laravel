        ...
        <div class="container bg-glass px-4 py-5  text-center text-lg-start my-5" style="overflow-y:auto">
            ...
            <div class="tab-class text-center wow fadeInUp" data-wow-delay="0.1s">
                <ul class="nav nav-pills d-inline-flex justify-content-center border-bottom mb-5" style="color:white;">
                    <li class="nav-item">
                        <a class="d-flex align-items-center text-start mx-3 ms-0 pb-3 active" data-bs-toggle="pill" href="#tab-1" style="color:white; font-size:20px">
                            All
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="d-flex align-items-center text-start mx-3 pb-3" data-bs-toggle="pill" href="#tab-2" style="color:white; font-size:20px">
                            Burger
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="d-flex align-items-center text-start mx-3 me-0 pb-3" data-bs-toggle="pill" href="#tab-3" style="color:white; font-size:20px">
                            Pizza
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="d-flex align-items-center text-start mx-3 me-0 pb-3" data-bs-toggle="pill" href="#tab-4" style="color:white; font-size:20px">
                            Noodle
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="d-flex align-items-center text-start mx-3 me-0 pb-3" data-bs-toggle="pill" href="#tab-5" style="color:white; font-size:20px">
                            Steak
                        </a>
                    </li>
                </ul>
                <div class="tab-content">
                    ...
                    <div id="tab-1" class="tab-pane fade show p-0 active">
                        <div class="row row-cols-1 row-cols-sm-1 row-cols-md-2 row-cols-lg-3 g-4 py-5 d-flex justify-content-around ">
                                ...
                                <div class="" style="padding:10px;">
                                    ...
                                    <div class="d-flex justify-content-between w-100 p-2">
                                        ...
                                        <a href="{{ url('menuCheckout') }}">
                                            <div style="border-radius: 50px; width: 35px; height: 35px; background-color: orange; padding: 5px 10px 8px 8px">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="currentColor" class="bi bi-cart-plus-fill" viewBox="0 -2 18 18" style="color:white;">
